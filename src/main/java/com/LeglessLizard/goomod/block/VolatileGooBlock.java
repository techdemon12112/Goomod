...
public class VolatileGooBlock extends Block {
    ...
    public VolatileGooBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
                ...
                if (currentTick >= graceEnd) {
                    ...
                    if (deadline != null && currentTick >= deadline) {
                        if (random.nextInt(80) == 0) {
                            level.setBlock(pos, ((Block)ModBlocks.PRIMED_GOO_BLOCK.get()).defaultBlockState(), 3);
                        } else {
